...
/** \mainpage RoboComp::worldDumper
 *
 * \section intro_sec Introduction
 *
 * The worldDumper component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/worldDumper --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class worldDumper : public RoboComp::Application
{
public:
	worldDumper (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::worldDumper::run(int argc, char* argv[])
{
